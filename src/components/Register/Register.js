...
export default function Register() {
  ...
  const runScript = () => {
    ...
    if (
      !getConfirmPassword.includes(getPassword) ||
    ...
    axios
      ...
      .then((res) => {
        if (res.data.STATUS) {
          setCookies("Customer", res.data.PACKAGE, {
            path: "/",
          ...
          <div className="card-body">
            ...
            <div className="form-group">
              ...
              <input
                ...
                required
              ></input>
              {getConfirmPassword === getPassword ? null : <p>sai mật khẩu</p>}
            </div>
            <div class="row">
              <div class="col-sm-3">
                <div style={{ fontWeight: "bolder", padding: "2px" }}>
                  Ngày Sinh
                </div>
                <select
                  name="Day"
            ...
            <br></br>
            <button className="btn btn-success" onClick={runScript}>
              Đăng ký
            </button>
          </div>
        </div>
